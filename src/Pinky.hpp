...
public:
    ...
    Pinky(std::pair<size_t, size_t> levelMatrixDim);
	~Pinky();
...
private:
    ...
    const float CHANGE_DIRECTION_PROBABILITY = 0.80f;  // Probability of change once minimum time is exceeded
